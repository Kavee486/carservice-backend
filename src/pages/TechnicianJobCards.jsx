...
const TechnicianJobCards = () => {
  ...
  // Get status priority for sorting (Pending -> In Progress -> Completed -> Job Done -> Others)
  ...
  const getSortedJobCards = (cards) => {
    ...
    return [...cards].sort((a, b) => {
      ...
      if (aStatusPriority !== bStatusPriority) {
        return aStatusPriority - bStatusPriority; // Ascending order for priority (1,2,3,4)
      }
  ...
  const technicianJobCards = sortedFilteredJobCards; // Use sorted filtered job cards
  ...
  const jobDoneJobs = technicianJobCards.filter(jobCard => jobCard.J_JobCardStatus === 'Job Done').length;
    ...
    <div className="h-full p-4 md:p-6">
      <div className="w-full space-y-6">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl shadow-lg text-white p-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-blue-100">View and manage your assigned job cards (Sorted by: Pending → In Progress → Completed → Job Done)</p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          ...
          <StatCard
            title="Job Done"
            value={jobCardStats.jobDoneJobs}
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-200">
          ...
          <div className="mt-2">
            <span className="text-sm text-gray-600">
              Showing {sortedFilteredJobCards.length} of {dedupedJobCards.length} job cards
